...
function send_verification_email($email, $name, $verification_code) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'dvonderick@gmail.com'; // Your email
        $mail->Password = 'lhqa ggfi hsst mimk'; // Your app password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;
        
        // Recipients
        $mail->setFrom('41004.ERS@gmail.com', 'Emergency Response System');
        $mail->addAddress($email, $name);
        
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Email Verification - Emergency Response System';
        $mail->Body = "
            <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8fff5ff; border: 1px solid #edffd6ff; border-radius: 10px; overflow: hidden;'>
                <div style='background: linear-gradient(135deg, #29EA3C , #29EA3C ); padding: 30px; text-align: center; color: white;'>
                    <h1 style='margin: 0; font-size: 28px;'>🔔 Emergency & Response Management</h1>
                    <p style='margin: 10px 0 0 0; opacity: 0.9;'>Emergency Response System</p>
                </div>
                
                <div style='padding: 30px;'>
                    <h2 style='color: #29EA3C ; margin-top: 0;'>Email Verification</h2>
                    <p>Hello <strong>$name</strong>,</p>
                    <p>Thank you for registering with <strong>Emergency Response System</strong>. Please use the verification code below to complete your registration:</p>
                    
                    <div style='text-align: center; margin: 30px 0;'>
                        <div style='display: inline-block; padding: 15px 30px; background: #f6fef2ff; border: 2px dashed #29EA3C ; border-radius: 8px; font-family: monospace;'>
                            <h3 style='color: #29EA3C ; font-size: 28px; margin: 0; letter-spacing: 3px;'>$verification_code</h3>
                        </div>
                    </div>
                    
                    <div style='background: #f4fef2ff; padding: 15px; border-radius: 5px; border-left: 4px solid #29EA3C ;'>
                        <p style='margin: 0; color: #29EA3C ; font-size: 14px;'>
                ...
                <div style='background: #f6fef2ff; padding: 20px; text-align: center; border-top: 1px solid #d9fecaff;'>
                    <p style='margin: 0; color: #29EA3C ;'>
                        <strong>📣 Safety First:</strong> Always have an emergency evacuation plan and working smoke detectors.
                    </p>
                    <p style='margin: 10px 0 0 0; color: #666; font-size: 12px;'>
                        Best regards,<br>
                        <strong>Emergency Response Management Team</strong><br>
