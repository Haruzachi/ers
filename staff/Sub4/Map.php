...
<head>
    ...
    <title>Live Map Interface</title>
...
<div class="menu-section">
    ...
    <div class="menu-items">
        ...
        <div class="menu-item active" onclick="toggleSubmenu('schedule')">
        ...
        <div id="schedule" class="submenu">
            <a href="" class="submenu-item active">Live Map Interface</a>
...
function fetchNotifications() {
    fetch('Map.php?action=fetch_notifications')
    .then(res => res.json())
    .then(data => {
