    ...
    <div class="dashboard-animation" id="dashboard-animation">
        <div class="animation-logo">
            <div class="animation-logo-icon">
                <img src="../img/Logocircle.png" alt="Fire & Rescue Logo" style="width: 70px; height: 75px;">
            </div>
            <span class="animation-logo-text">Emergency & Response</span>
        </div>
            ...
            <div class="dashboard-content">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card stat-card-white">
                        ...
                        <div class="stat-value">----<span style="font-size: 24px;">----</span></div>
                        <div class="stat-info">
                            <svg class="stat-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                            </svg>
                ...
                <div class="main-grid">
                        ...
                        <div class="card">
                            ...
                            <div class="response-chart">
                                <div class="chart-bar">
                                    ...
                                    <span class="chart-bar-label">-----------</span>
                                </div>
                                <div class="chart-bar">
                    ...
                    <div class="right-column">
                        <div class="card">
                            <h2 class="card-title">Emergency Response</h2>
...
function fetchNotifications() {
    fetch('staff_dashboard.php?action=fetch_notifications')
    .then(res => res.json())
    .then(data => {
