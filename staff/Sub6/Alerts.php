...
<head>
    ...
    <title>Notification & Alerts Management</title>
...
<div class="menu-section">
    ...
    <div class="menu-items">
        ...
        <div class="menu-item active" onclick="toggleSubmenu('inspection')">
        ...
        <div id="inspection" class="submenu">
            ...
            <a href="" class="submenu-item active">Notification Alerts</a>
        </div>
...
function fetchNotifications() {
    fetch('Alerts.php?action=fetch_notifications')
    .then(res => res.json())
    .then(data => {
