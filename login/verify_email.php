...
<head>
    ...
    <title>Verify Email - Emergency Response System</title>
    <link rel="icon" type="image/png" href="../img/Logocircle.png">
    ...
    <style>
        * {
        ...
        :root {
            --primary-color: #29EA3C;
            --primary-dark: #18c529ff;
            --secondary-color: #29EA3C;
            --secondary-dark: #18be28ff;
        ...
        .dark-mode-toggle {
            ...
            top: 40px;
            right: 20px;
            background: linear-gradient(135deg, rgba(41,234,60), rgba(41,234,60));
        ...
        .dark-mode-toggle:hover {
            ...
            box-shadow: 0 12px 35px rgba(41,234,60);
        }
        ...
        .logo-left img {
            width: 240px;
            height: auto;
            filter: drop-shadow(0 20px 50px rgba(0,0,0,0.5)) drop-shadow(0 0 30px rgba(41,234,60));
            margin-bottom: 35px;
        ...
        .logo-left h3 {
            ...
            font-weight: 900;
            margin-bottom: 18px;
            text-shadow: 0 6px 25px rgba(0,0,0,0.4), 0 0 40px rgba(41, 234, 59);
            letter-spacing: 3px;
            background: linear-gradient(135deg, #00ff1aff, #ffffffff, #29EA3C);
        ...
        .verify-logo img {
            width: 100px;
            height: auto;
            filter: drop-shadow(0 8px 20px rgba(0,0,0,0.3)) drop-shadow(0 0 20px rgba(41,234,60));
        ...
        .verification-code-input:focus {
            ...
            box-shadow: 0 0 0 5px rgba(41,234,60), 0 8px 20px rgba(41,234,60);
        ...
        .btn-primary {
            ...
            box-shadow: 0 8px 25px rgba(41,234,60);
            position: relative;
            overflow: hidden;
            letter-spacing: 1px;
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 15px 40px rgba(41,234,60), 0 0 30px rgba(41,234,60);
        }
        ...
        .resend-container {
            margin-top: 25px;
            padding: 20px;
            background: linear-gradient(135deg, rgba(41,234,60), rgba(0, 0, 0, 0.05));
            border-radius: 15px;
        ...
        .resend-btn:hover {
            ...
            color: white;
            transform: translateY(-3px);
            box-shadow: 0 8px 20px rgba(41,234,60);
        }
...
<body>
    ...
    <div class="logo-left">
        <img src="../img/logocircle.png" alt="Fire & Rescue Services Logo">
        <h3>Emergency & Response</h3>
        <p class="tagline">Emergency Response Management</p>
    </div>
    
    <div class="verify-container">
        <div class="verify-logo">
            <img src="../img/logocircle.png" alt="Fire & Rescue Services">
        </div>
